    ...
    <div id="content">
        ...
        <div class="main-content">
            ...
            <div class="row mt-3">
                <div class="content-header">
                    <div class="col-lg-12 d-flex align-items-center">
                        <span class="header-title border-end pe-3">DRIVER INFO</span>
            ...
            <div class="card p-3" id="main-profile">
                                ...
                                <table class="mt-2 mt-xl-0 w-100">
                                    ...
                                    <tr>
                                        <th class="pb-50 d-flex justify-item-center mb-2">
                                            ...
                                            <span class="driver-right-title ps-1 font-weight-bold">Sponsor Email</span>
                                        </th>
                                        <td style="text-transform: none" align="right">
                                            <span class="driver-right-title">
                                                @if ($driver->operator_id != null)
                ...
                @if ($driver->verification_status_id != 7 && $operator->operator_verification_status_id == 4)
                        ...
                        <div class="container-bar col-lg-12" id="footer-container">
                            ...
                            <div class="progress-container col-lg-12 mt-5 d-flex justify-content-between">
                                ...
                                <div class="circle d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="status-alert" id="status-alert-kyc">
                                ...
                                <div class="circle d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="status-alert" id="status-alert-training">
                                        <small class="text-muted">
                                            Waiting for driver to complete the training
                                        </small>
                                    </div>
                                </div>
                                <div class="circle d-flex justify-content-center align-items-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 p-2 ">
                                    ...
                                    <label for="" class="d-flex justify-content-center"><small>Driver
                                            License</small></label>
                                </div>
                                {{-- NBI Clearance --}}
                                <div class="col-lg-6 p-2">
...
@push('scripts')
    ...
    <script>
        ...
        let operator_sub_type = @json($driver->operator->operatorType->id, JSON_PRETTY_PRINT);
        let currentActive = @json($driver->verification_status_id, JSON_PRETTY_PRINT);
        let operator_verification_status_if = @json($operator->operator_verification_status_id == 2, JSON_PRETTY_PRINT);
        ...
        // access routes
        if (currentActive != 7 && operator_verification_status_if == 2) {
            for (let i = 0; i < accept.length; i++) {
                accept[i].addEventListener("click", () => {
                    if (currentActive === 5) {
                        document.location.href =
                            "{{ route('operator.updateDriverVerificationId', ['id' => $driver->user_id, 'status_id' => 6]) }}";
                    }
                });
                decline[i].addEventListener("click", () => {
                    document.location.href =
                        "{{ route('operator.updateDriverVerificationId', ['id' => $driver->user_id, 'status_id' => 7]) }}";
                });
            }
        }
        ...
        function update() {
            if (currentActive != 7 && operator_verification_status_if == 2) {
                // padding
                if (currentActive === 3 || currentActive === 4 || currentActive === 5) {
                    footer_container.classList.add('mb-5');
                } else {
                    footer_container.classList.remove('mb-5');
                }

                // showing buttons
                if (currentActive === 3) {
                    document.getElementById('status-alert-kyc').style.visibility = 'visible';
                }
                else if (currentActive === 4) {
                    document.getElementById('status-alert-training').style.visibility = 'visible';
                }
                else if (currentActive === 5) {
                    document.getElementById('status-buttons-pending').style.visibility = 'visible';
                }
            }
