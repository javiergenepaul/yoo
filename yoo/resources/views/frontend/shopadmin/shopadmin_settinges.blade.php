...
@section('title', 'Settings Page shopadmin')
                    ...
                    <div class="d-flex align-items-start p-3">
                        ...
                        <div class="tab-content col-lg-9" id="v-pills-tabContent">
                            <div class="tab-pane fade show px-4 active" id="general" role="tabpanel"
                                ...
                                {{-- form --}}
                                <form id="update-profile-form" action="" method="POST" enctype="multipart/form-data" class="row g-3 mb-3">
                                    @csrf
        ...
        $(document).ready(function() {
            ...
            function walletUpdateButton() {
                $('.wallet-update-btn').off('click').on('click', function() {
                    let url = "{{ route('shopadmin.settingsWalletFetch', ':id') }}";
            ...
            $('#update-wallet-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.settingsWalletUpdate') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#connect-wallet-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.settingsWalletConnect') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#disconnect-wallet-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.settingsWalletDisconnect') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#update-profile-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $('#connect-wallet-btn').attr('disabled', true).text('processing');
                    $.ajax({
                        url: "{{ route('shopadmin.settingsUpdateProfile') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#change-pass-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.settingsChangePassSendOtp') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#otp-verification-form').validate({
                submitHandler: function(form, event) {
                    event.preventDefault();
                    $.ajax({
                        url: "{{ route('shopadmin.settingsChangePassConfirmOtp') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
