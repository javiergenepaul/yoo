                                    ...
                                    <div class="col-lg-5">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-8 d-flex justify-content-end pe-5">
                                                <span class="text-muted" id="item-id-view">
                                                    Sample id
                                                </span>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-8 d-flex justify-content-end pe-5">
                                                <span class="text-muted" id="item-cost-view">
                                                    Sample
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-8 d-flex justify-content-end pe-5">
                                                <span class="text-muted text-capitalize" id="item-markup-view">
                                                    Sample type
                                                </span>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-8 d-flex justify-content-end pe-5">
                                                <span class="text-muted text-capitalize" id="item-total-view">
                                                    Sample type
                                                </span>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-8 d-flex justify-content-end pe-5">
                                                <span class="fw-boldtext-muted" id="item-category-view">
                                                    Item Code
                                                </span>
                                            </div>
                                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        @switch($type)
                            @case('publish')
                                <div class="d-flex align-items-center home-logo">
                                    <small>
                                        <a href="{{ route('shopadmin.shop', ['publish', 'view' => 'grid']) }}">
                            ...
                            @case('pending')
                                <div class="d-flex align-items-center home-logo">
                                    <small>
                                        <a href="{{ route('shopadmin.shop', ['pending', 'view' => 'grid']) }}">
                            ...
                            @case('my')
                                <div class="d-flex align-items-center home-logo">
                                    <small>
                                        <a href="{{ route('shopadmin.shop', ['my', 'view' => 'grid']) }}">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function itemInfo(item_id) {
                item_info_url = "{{ route('shopadmin.shopInfoItemInfoFetch', ':id') }}";
            ...
            function itemSwitch() {
                $('input.toggler').off('click').on('click', function() {
                    ...
                    let i_url = "{{ route('shopadmin.shopInfoItemToggleFetchItem', ':id') }}";
            ...
            function editItemButton() {
                $('.edit-item-btn').on('click', function() {
                    item_fetch_url = "{{ route('shopadmin.shopInfoEditItemFetch', ':shop_info_id') }}";
            ...
            function editItemComboBtn() {
                $('.edit-item-combo-btn').off('click').on('click', function() {
                    ...
                    var item_combo_fetch_url = "{{ route('shopadmin.shopInfoEditItemComboFetch', ':item_combo_id') }}";
            ...
            function editItemVariantBtn() {
                $('.edit-item-variant-btn').off('click').on('click', function() {
                    $(this).attr('disabled', true);
                    item_variant_fetch_url = "{{ route('shopadmin.shopInfoEditItemVariantFetch', ':item_combo_id') }}";
            ...
            $('#publish-btn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('shopadmin.shopInfoPublish', $shop->id) }}",
                    method: "GET",
                    contentType: false,
                    cache: false,
                    processData: false,
            ...
            $('#approve-btn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('shopadmin.shopInfoApproveDecline', ['id' => $shop->id, 'status' => 'approve']) }}",
                    method: "GET",
                    contentType: false,
                    cache: false,
                    processData: false,
            ...
            $('#decline-btn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('shopadmin.shopInfoApproveDecline', ['id' => $shop->id, 'status' => 'decline']) }}",
                    method: "GET",
                    contentType: false,
                    cache: false,
                    processData: false,
            ...
            $('#add-category-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoAddCategory') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#add-item-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoAddItem') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                        ...
                        success: function(response) {
                            ...
                            if ($('.empty-item-' + response.item.item_category_id)) {
                                $('.empty-item-' + response.item.item_category_id)
                                    .fadeOut().remove();
                            }
                            item_image = "{{ asset('storage/item_image/:img') }}";
                            item_image = item_image.replace(':img', response.item.image);
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-5 col-xs-6" id="item-id-${ response.item.id }" >
                                <div class="card">
                                    <div class="position-relative">
                                        <img id="item-image-${ response.item.id }" src="${ item_image }"
                                            class="img-fluid rounded-top"
                                            style="height: 200px; width: 100%;">
                                        <div class="position-absolute top-0 start-0 p-2">
                                            <div class="dropdown">
            ...
            $('#add-shop-hour-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoAddShopHour') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-form').validate({
                ...
                submitHandler: function(form, event) {
                    event.preventDefault();
                    $('#edit-item-btn').attr('disabled', true).text('processing');
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoEditItem') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                        ...
                        data: new FormData(form),
                        complete: function() {
                            $('#edit-item-btn').attr('disabled', false).text('Proceed');
                        },
                        success: function(response) {
                            console.log(response);
                            Swal.fire({
            ...
            $('#delete-item-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoDeleteItem') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#add-item-variant-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoAddItemVariant') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#add-combo-category-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoAddItemComboCategory') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#add-item-combo-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoAddItemCombo') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#add-note-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoAddNote') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#toggle-item-form').validate({
                submitHandler: function(form, event) {
                    ...
                    event.preventDefault();;
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoItemToggleStatusUpdate') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-combo-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoEditItemCombo') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#delete-item-combo-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $('#edit-item-combo-btn').attr('disabled', true).text('processing');
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoDeleteItemCombo') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-variant-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoEditItemVariant') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#delete-item-variant-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $('#edit-item-variant-btn').attr('disabled', true).text('processing');
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoDeleteItemVariant') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-shop-image-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoEditShopImage') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-image-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('shopadmin.shopInfoEditItemImage') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
