...
@push('modal')
    <div class="modal fade" id="update-wallet-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        data-bs-keyboard="false" data-bs-target="#staticBackdrop">
                ...
                <div class="modal-body">
                    <form id="update-wallet-form" method="POST" action="">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" id="update-acc-name" name="acc_name" class="form-control" placeholder=" ">
                            <label for="notes">Account Name or Address</label>
                        </div>
                        <div class="form-floating">
                            <input type="text" id="update-acc-no" name="acc_no" class="form-control" placeholder=" ">
    ...
    <div class="modal fade" id="disconnect-wallet-modal" data-bs-backdrop="modal" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal fade" id="connect-wallet-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        data-bs-keyboard="false" data-bs-target="#staticBackdrop">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="otp-verification-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true" data-bs-keyboard="false" data-bs-target="#staticBackdrop">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start p-3">
                        <div class="nav flex-column nav-pills col-lg-3 " id="v-pills-tab" role="tablist"
                            ...
                            {{-- <a href="{{ route('changePass.changePassInside') }}">
                                <button class="nav-link d-flex col-lg-12" data-bs-toggle="pill">
                                    <span class="material-icons pe-2">vpn_key</span>
                                    Change Password
                                </button>
                            </a> --}}
                        ...
                        <div class="tab-content col-lg-9" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show px-4 active" id="general" role="tabpanel"
                                ...
                                <form id="update-profile-form" action="" method="POST"
                                            ...
                                            <div class="profile-picture">
                                                <div class="profile-container">
                                                    <div class="crop-profile px-0">
                                                        @if ($management->user->userInfo->profile_picture != null)
                                                            <img id="profile-pircure-img" class="img-fluid"
                                                                src="{{ asset('storage/profile_picture/' . $management->user->userInfo->profile_picture) }}"
                                                                type="button">
                                                        @else
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mt-2">
                                            <input type="mobile"
                                                ...
                                                value="{{ $management->user->mobile_number }}" readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mt-2">
                                            <input type="text"
                                                ...
                                                value="{{ $management->user->userInfo->fb_link }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text"
                                                ...
                                                value="{{ $management->user->userInfo->first_name }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text"
                                                ...
                                                value="{{ $management->user->userInfo->last_name }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mt-2">
                                            <input type="text"
                                                ...
                                                value="{{ $management->user->userInfo->middle_name }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mt-2">
                                            <input type="date"
                                                ...
                                                value="{{ $management->user->userInfo->date_of_birth }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mt-2">
                                            <input type="text"
                                                ...
                                                value="{{ $management->user->userInfo->address }}">
                                    ...
                                    <input type="hidden" id="province" name="province"
                                        value="{{ $management->user->userInfo->province }}">
                                    <div class="col-md-6">
                                        <div class="form-floating mt-2">
                                            <select name="province_code" id="province_code" class="form-select"
                                                ...
                                                @if ($user->userInfo->province_code != null)
                                                    ...
                                                    <option value="{{ $user->userInfo->province_code }}" selected>
                                                        {{ $management->user->userInfo->province }}
                                                    </option>
                                                @else
                                                    <option value="0" selected>select province</option>
                                                @endif
                                    ...
                                    <input type="hidden" id="city_municipality" name="city_municipality"
                                        value="{{ $management->user->userInfo->city_municipality }}">
                                    <div class="col-md-5">
                                        <div class="form-floating mt-2">
                                    ...
                                    <input type="hidden" id="barangay" name="barangay"
                                        value="{{ $management->user->userInfo->barangay }}">
                                    <div class="col-md-4">
                                        <div class="form-floating mt-2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating mt-2">
                                            <input type="text"
                                                ...
                                                value="{{ $management->user->userInfo->postal_code }}">
                            ...
                            <div class="tab-pane fade show px-4" id="change-pass" role="tabpanel"
                                ...
                                <form id="change-pass-form" action="" method="POST">
                                    ...
                                    <div class="mb-2">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="old-password" name="old_password" placeholder="Password" type="password">
                                            <label for="floatingInput">Old Password</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="new-password" name="new_password" placeholder="Password" type="password">
                                            <label for="floatingInput">New Password</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="new-password-confirmation" name="new_password_confirmation" placeholder="Password Confirmation" type="password">
                                            <label for="floatingInput">New Password Confirmation</label>
                                        </div>
                                    </div>
                                    <div>
                                        <button type="button" id="change-pass-reset-btn" class="btn btn-outline-secondary me-2">Reset</button>
                                        <button type="submit" id="change-pass-btn" form="change-pass-form" class="btn btn-primary">Save Changes</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            function walletUpdateButton() {
                $('.wallet-update-btn').off('click').on('click', function() {
                    let url = "{{ route('management.settingsWalletFetch', ':id') }}";
            ...
            $('#update-wallet-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.settingsWalletUpdate') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#connect-wallet-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.settingsWalletConnect') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#disconnect-wallet-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.settingsWalletDisconnect') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#update-profile-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    // $('#connect-wallet-btn').attr('disabled', true).text('processing');
                    $.ajax({
                        url: "{{ route('management.settingsUpdateProfile') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#change-pass-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.settingsChangePassSendOtp') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#otp-verification-form').validate({
                submitHandler: function(form, event) {
                    event.preventDefault();
                    $.ajax({
                        url: "{{ route('management.settingsChangePassConfirmOtp') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#otp-verification-form').find('.otp-input').each(function(index) {
                ...
                $(this).on('keyup', function() {
                    ...
                    if ($('#first').val() != '' && $('#fourth').val() != '' && $('#third').val() != '' && $('#fourth').val() != '') {
                        $(this).blur();
                        $('#otp_code').val($('#first').val() + $('#second').val() + $('#third').val() + $('#fourth').val());
