        ...
        $(document).ready(function() {
            ...
            function shopListTable() {
                $('#shop-list-table').DataTable({
                    ...
                    ajax: {
                        type: "GET",
                        url: "{{ route('management.shopFetchTable', 'publish') }}",
                        dataType: "json",
            ...
            $("#view-type").on('click',function() {
                ...
                if (view != 'table') {
                    ...
                    window.history.pushState({}, '',
                        "{{ route('management.shop', ['type' => 'publish', 'view' => 'table']) }}");
                    ...
                    window.history.pushState({}, '',
                        "{{ route('management.shop', ['type' => 'publish', 'view' => 'grid']) }}");
                }
            });
                            ...
                            if (response.place_id_null) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        var url =
                                            "{{ route('management.shopInfo', ['type' => 'publish', 'id' => ':id']) }}";
