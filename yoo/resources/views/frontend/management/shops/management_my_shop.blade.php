                                                ...
                                                <div class="col-lg-2 col-md-3 col-sm-5 col-xs-6" id="shop-id-{{ $shop->id }}">
                                                    <div class="card">
                                                        ...
                                                        <div class="çard-footer p-3">
                                                            <a class="btn btn-primary" href="{{ route('management.shopInfo', ['type' => 'my', 'id' => $shop->id]) }}" style="font-size: 15px;">
                                                                View More
                                                            </a>
                                                        </div>
                                                    </div>
        ...
        $(document).ready(function() {
            ...
            function shopListTable() {
                $('#shop-list-table').DataTable({
                    ...
                    ajax: {
                        type: "GET",
                        url: "{{ route('management.shopFetchTable', 'my') }}",
                        dataType: "json",
            ...
            $("#view-type").on('click', function() {
                ...
                if (view != 'table') {
                    ...
                    window.history.pushState({}, '',
                        "{{ route('management.shop', ['type' => 'my', 'view' => 'table']) }}");
                    ...
                    window.history.pushState({}, '',
                        "{{ route('management.shop', ['type' => 'my', 'view' => 'grid']) }}");
                }
            });
            ...
            $("input.toggler").on('click', function() {
                ...
                let t_url = "{{ route('management.shopInfoToggleFetch', ':id') }}";
                            ...
                            if (response.place_id_null) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        var url =
                                            "{{ route('management.shopInfo', ['type' => 'my', 'id' => ':id']) }}";
