...
@push('modal')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="add-category-form" class="btn btn-primary"
                        id="add-category-submit-btn">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="add-note-modal" tabindex="-1" data-bs-backdrop="static"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add-note-form" action="" method="POST">
                        ...
                        <input type="hidden" name="shop_id" value="{{ $shop->id }}">
                        <div class=" form-floating mb-3">
                            <input type="text" class="cost form-control" name="title" id="title-note"
                                placeholder=" ">
                            <label for="category">Title</label>
                        </div>
                        <div class="form-floating mb-3">
                            <textarea class="form-control" id="notes" name="notes" placeholder=" " style="height: 100px"></textarea>
                            <label for="category">Notes</label>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="submit" form="add-note-form" class="btn btn-primary" id="add-note-submit-btn">
                        Submit
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="toggle-shop-modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" form="toggle-shop-form" class="btn btn-primary" id="toggle-shop-form-btn">Proceed</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="toggle-item-modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" id="toggle-item-btn" form="toggle-item-form" class="btn btn-primary"
    ...
    <div class="modal fade" id="add-item-category-combo-modal" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" form="add-combo-category-form" id="add-combo-category-form-btn">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="add-item-variant-modal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel2">Add New Item Variant</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" form="add-item-variant-form" id="add-item-variant-form-btn">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="add-shophour-modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                            ...
                            @foreach ($shop_day as $day)
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="time" class="form-control"
                                                name="{{ $day->day }}_opening" id="{{ $day->day }}_opening"
                                                placeholder=" ">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="time" class="form-control"
                                                name="{{ $day->day }}_closing" id="{{ $day->day }}_closing"
                                                placeholder=" ">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button id="add-shophour-submit-btn" type="submit" form="add-shop-hour-form"
        ...
        <div class="main-content">
            <div class="row mt-3">
                <div class="content-header d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        @switch($type)
                            @case('publish')
                                <div class="d-flex align-items-center home-logo">
                                    <small>
                                        <a href="{{ route('management.shop', ['publish', 'view' => 'grid']) }}">
                            ...
                            @case('pending')
                                <div class="d-flex align-items-center home-logo">
                                    <small>
                                        <a href="{{ route('management.shop', ['pending', 'view' => 'grid']) }}">
                            ...
                            @case('my')
                                <div class="d-flex align-items-center home-logo">
                                    <small>
                                        <a href="{{ route('management.shop', ['my', 'view' => 'grid']) }}">
                    ...
                    <div id="header-btn-div" class="d-flex align-items-center">
                        @if ($shop->shop_status_id == 3)
                            <div class="form-check form-switch mx-3">
                                <input type="checkbox" class="form-check-input" id="headerToggle" checked>
                            </div>
                        @elseif ($shop->shop_status_id == 4)
                            <div class="form-check form-switch mx-3">
                                <input type="checkbox" class="form-check-input" id="headerToggle">
                            </div>
                        @endif
                        @if (!auth()->user()->management)
                            @if ($shop->shop_status_id == 1)
                                <button class="btn btn-primary me-2" id="publish-btn"
                                    @if ($shop->shopHour->isEmpty() || $shop->itemCategories->isEmpty() || $shop->items->isEmpty()) disabled @endif>
                                    Publish
                                </button>
                            @endif
                            ...
                            <button class="btn btn-primary me-2" data-bs-toggle="modal" id="add-category-btn"
                        ...
                        @else
                            @if ($shop->shop_status_id == 2)
                                ...
                                <button class="btn btn-danger me-2" id="decline-btn"
                                    @if ($shop->shopHour->isEmpty() || $shop->itemCategories->isEmpty() || $shop->items->isEmpty()) disabled @endif>
                                    Reject
                                </button>
                            @elseif ($shop->shop_status_id == 5)
                                <button id="add-note" class="btn btn-primary me-2" data-bs-toggle="modal"
                                    data-bs-target="#add-note-modal" @if ($shop->itemCategories->isEmpty()) disabled @endif>
                                    <div class="d-flex align-items-center">
                                        Add note
                                    </div>
                                </button>
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    <div class="col">
                                        <div class="crop-profile me-4">
                                            @if ($shop->image != null)
                                                <img id="shop-image" class="shop-image" src="{{ asset('storage/shop_image/' . $shop->image) }}">
        ...
        $(document).ready(function() {
            ...
            function shopComboCategory(content, category) {
                ...
                if (category.item_combo.length != 0) {
                    $.each(category.item_combo, function(key, item) {
                        let total_amount = parseInt(item.cost) + parseInt(item.markup);
                        item_combo = `
                            <div class="d-flex justify-content-between align-items-center">
                                <li>${ formatToCurrency(total_amount) } - ${ item.combo }</li>
                                <div>
            ...
            function shopVariant(content, variant) {
                ...
                variant.forEach(variant => {
                    variant_sum = parseInt(variant.cost) + parseInt(variant.markup);
                    item_variant = `
                        <div class="d-flex justify-content-between align-items-center">
                            <li>${ formatToCurrency(variant_sum) } - ${ variant.variant }</li>
                            <div>
            ...
            function itemInfo(item_id) {
                item_info_url = "{{ route('management.shopInfoItemInfoFetch', ':id') }}";
            ...
            function itemSwitch() {
                $('input.toggler').off('click').on('click', function() {
                    ...
                    let i_url = "{{ route('management.shopInfoItemToggleFetchItem', ':id') }}";
            ...
            function editItemButton() {
                $('.edit-item-btn').on('click', function() {
                    item_fetch_url = "{{ route('management.shopInfoEditItemFetch', ':shop_info_id') }}";
            ...
            function editItemComboBtn() {
                $('.edit-item-combo-btn').off('click').on('click', function() {
                    ...
                    var item_combo_fetch_url = "{{ route('management.shopInfoEditItemComboFetch', ':item_combo_id') }}";
            ...
            function editItemVariantBtn() {
                $('.edit-item-variant-btn').off('click').on('click', function() {
                    $(this).attr('disabled', true);
                    item_variant_fetch_url = "{{ route('management.shopInfoEditItemVariantFetch', ':item_combo_id') }}";
            ...
            $('#add-item-combo-modal').on('hidden.bs.modal', function() {
                ...
                $('#item-combo-markup-model').fadeOut();
            });
            ...
            $('#publish-btn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('management.shopInfoPublish', $shop->id) }}",
                    method: "GET",
                    contentType: false,
                    cache: false,
                    processData: false,
                    dataType: "JSON",
                    complete: function() {
                        $('#publish-btn').text('success!').fadeOut(function() {
                            form_check = $(document.createElement('div')).addClass(
                                'form-check form-switch mx-3').prependTo(
                                '#header-btn-div');
                            $(document.createElement('input')).attr({
                                    'type': 'checkbox',
                                    'id': 'headerToggle'
                                }).prop('checked', true)
                                .addClass('form-check-input').appendTo(form_check);
                            headerSwitch();
                        });
                    },
                    success: function(response) {
                        ...
                        $("#shop-status-refresh").load(window.location.href +
                            " #shop-status-refresh");
                        $('#shop_status').css("background-color", "#198745");
            ...
            $('#approve-btn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('management.shopInfoApproveDecline', ['id' => $shop->id, 'status' => 'approve']) }}",
                    method: "GET",
                    contentType: false,
                    cache: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        $('#approve-btn').fadeOut();
                        $('#decline-btn').fadeOut();
                        $("#shop-status-refresh").text('Published').parent().css(
                        ...
                        $('#header-btn-div').html(approve_sw);
                        headerSwitch();
            ...
            $('#decline-btn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('management.shopInfoApproveDecline', ['id' => $shop->id, 'status' => 'decline']) }}",
                    method: "GET",
                    contentType: false,
                    cache: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        $('#approve-btn').fadeOut().detach();
                        $('#decline-btn').fadeOut().detach();
                        $("#shop-status-refresh").load(window.location.href +
                            " #shop-status-refresh");
                        $('#shop_status').css("background-color", "#DC3545");
                        ...
                        $(document.createElement('btn'))
                            ...
                            .attr({
                                ...
                                'data-bs-target': '#add-note-modal'
                            }).text('Add note')
                            .css({
                                'display': 'none'
                            })
                            .appendTo($('#header-btn-div'));
                        $('#add-note').fadeIn();
            ...
            $('#add-category-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoAddCategory') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#add-item-form').validate({
                ...
                submitHandler: function(form, event) {
                    event.preventDefault();
                    $('#add-item-submit-btn').attr('disabled', true).text('please wait...');
                    $.ajax({
                        url: "{{ route('management.shopInfoAddItem') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                                    ...
                                    <div class="card">
                                        <div class="position-relative">
                                            ...
                                            <div class="form-check form-switch position-absolute top-0 end-0 p-2">
                                                <input class="form-check-input toggler" type="checkbox" id="flexSwitchCheckChecked" checked="checked" value="${ response.item.id }">
                                            </div>
                                            <div class="d-flex align-items-center position-absolute bottom-0 end-0 p-2">
                                                <span id="status-badge" class="badge rounded-pill text-capitalize p-2" style="background-color: rgb(25, 135, 84); font-size: 13px;">
                                                    Active
                                                </span>
                                            </div>
                                        </div>
            ...
            $('#add-shop-hour-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoAddShopHour') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                        ...
                        success: function(response) {
                            ...
                            response.shop_info.shop_hour.forEach(element => {
                                ...
                                col_hour = $(document.createElement('div'))
                                    .addClass(
                                        'col-8 d-flex justify-content-end pe-5')
                                    .appendTo(row);
                                hour = $(document.createElement('div'))
                                    .addClass('text-muted text-capitalize')
                                    .text(element.opening + ' AM' + ' - ' + element
                                        .closing + ' PM')
                                    .appendTo(col_hour);
                            });
            ...
            $('#add-item-variant-form').validate({
                ...
                submitHandler: function(form, event) {
                    event.preventDefault();
                    $('#add-item-variant-form-btn').attr('disabled', true).text('Processing');
                    $.ajax({
                        url: "{{ route('management.shopInfoAddItemVariant') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                        ...
                        data: new FormData(form),
                        success: function(response) {
                            $('#add-item-variant-form-btn').attr('disabled', false).text('Submit');
                            $('#add-item-variant-modal').modal('toggle');
                            $('#add-shop-hour-form').trigger('reset');
                            $('#item-variant-markup-model').fadeOut();
            ...
            $('#add-combo-category-form').validate({
                ...
                submitHandler: function(form, event) {
                    event.preventDefault();
                    $('#add-combo-category-form-btn').attr('disabled', true).text('Processing');
                    $.ajax({
                        url: "{{ route('management.shopInfoAddItemComboCategory') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                        ...
                        data: new FormData(form),
                        success: function(response) {
                            $('#add-combo-category-form-btn').attr('disabled', false).text('Submit');
            ...
            $('#add-item-combo-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoAddItemCombo') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#add-note-form').validate({
                ...
                submitHandler: function(form, event) {
                    event.preventDefault();
                    $('#add-note-submit-btn').attr('disabled', true).text('please wait...');
                    $.ajax({
                        url: "{{ route('management.shopInfoAddNote') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                        ...
                        data: new FormData(form),
                        complete: function() {
                            $('#add-note-submit-btn').attr('disabled', false)
                                .text('Submit');
                        },
                        success: function(response) {
                            Swal.fire({
            ...
            $('#toggle-item-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $('#toggle-item-btn').attr('disabled', true).text('processing');
                    event.preventDefault();;
                    $.ajax({
                        url: "{{ route('management.shopInfoItemToggleStatusUpdate') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
                        ...
                        data: new FormData(form),
                        complete: function () {
                            $('#toggle-item-btn').attr('disabled', false).text('Proceed');
                        },
                        success: function(response) {
                            Swal.fire({
                                icon: response.icon,
            ...
            $('#toggle-shop-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoToggleStatusUpdate') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoEditItem') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#delete-item-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoDeleteItem') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-combo-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoEditItemCombo') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#delete-item-combo-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $('#edit-item-combo-btn').attr('disabled', true).text('processing');
                    $.ajax({
                        url: "{{ route('management.shopInfoDeleteItemCombo') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-variant-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoEditItemVariant') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#delete-item-variant-form').validate({
                submitHandler: function(form, event) {
                    ...
                    $('#edit-item-variant-btn').attr('disabled', true).text('processing');
                    $.ajax({
                        url: "{{ route('management.shopInfoDeleteItemVariant') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-shop-image-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoEditShopImage') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
            ...
            $('#edit-item-image-form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        url: "{{ route('management.shopInfoEditItemImage') }}",
                        method: "POST",
                        contentType: false,
                        cache: false,
                        processData: false,
