...
@push('scripts')
    <script>
        ...
        function operatorTable(status_filter) {
            $('#management-operator').DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ route('management.userOperatorsFetch') }}",
                    dataType: "json",
                    data: {
        ...
        $('#status_filter').on('change', function() {
            ...
            operatorTable($('#status_filter').val());
        });
            ...
            submitHandler: function(form, event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#management-operator').DataTable().ajax
                            .reload();
                    },
