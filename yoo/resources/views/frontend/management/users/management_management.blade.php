                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="p-2" style="min-height: 600px">
                                <div class="card-content table-responsive">
                                    <table class="table table-hover" id="management-management" style="width: 100%">
...
@push('scripts')
    <script>
        $('#management-management').DataTable({
            ...
            ajax: {
                type: "GET",
                url: "{{ route('management.userManagementFetch') }}",
                dataType: "json",
            ...
            submitHandler: function(form, event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#management-management').DataTable().ajax
                            .reload();
                    },
